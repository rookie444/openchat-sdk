...
part '../../../../../generated/src/features/chat/chat_forward/blocs/chat_forward_event.freezed.dart';

/// 转发功能事件
@freezed
class ChatForwardEvent with _$ChatForwardEvent {
  /// 初始化转发页面
  const factory ChatForwardEvent.initialized({
  ...
  /// 执行转发
  const factory ChatForwardEvent.forwardMessages({
