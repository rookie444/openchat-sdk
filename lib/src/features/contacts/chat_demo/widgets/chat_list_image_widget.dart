...
import '../../../common/widgets/progress_image_widget.dart';

/// 聊天列表图片组件
/// 使用ProgressImageWidget进行状态管理，支持图片和视频消息的显示
class ChatListImageWidget extends StatefulWidget {
  final ChatMessageImageModel message;
  ...
  @override
  State<ChatListImageWidget> createState() => _ChatListImageWidgetState();
}

class _ChatListImageWidgetState extends State<ChatListImageWidget> {
  ...
  /// 处理重试加载
  void _handleRetryLoad(ChatMessageImageModel message) {
